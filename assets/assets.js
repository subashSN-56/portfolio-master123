...
import fullstack from './fullstack1.png';
...
export const workData = [
    {
        title: 'Real Time Chat & video call Application',
        bgImage: '/work-1.png',
        techstack: ['React', "DaisyUI" , 'Tailwind', 'Node.js', 'Socket.io' , 'MongoDB', 'Cloudinary','steamify' ],
        liveLink : 'https://chatapplive-xzgd.onrender.com/',
        gitubLink : 'https://github.com/subashSN-56/mern-stack-chat-app-main/tree/main/mern-stack-chat-app-main',
        description: 'A real-time chat-video-call application with CRUD functionalities using MongoDB.'
    },
    {
        title: 'Job Portal',
        bgImage: '/job-portal.png',
        techstack: ['MERN-Stack', 'Clerk' , 'Cloudinary',' Sentry' ],
           liveLink : 'https://job-portal-new123.vercel.app/',
        gitubLink : 'https://github.com/subashSN-56/job-portal-main',
    ...
    },
    {
        title: 'Quick AI',
        bgImage: 'work-2.png',
        techstack: ['MERN', 'Clerk', 'Gemini API',' Clipboard API', 'Cloudinary',' Neon (PostgreSQL)'],
           liveLink : 'http://sn-ai-gold.vercel.app',
        gitubLink : 'http://github.com/subashSN-56/SNQuickAi',
        description: 'Developed an AI-powered content and image generation platform offering tools for article writing, blog title creation, image generation, background/object removal, and resume review.Integrated Clerk authentication and Gemini + Clipboard APIs for intelligent text and image processing Utilized Cloudinary for dynamic image URL generation and Neon Cloud SQL for efficient data storage'
